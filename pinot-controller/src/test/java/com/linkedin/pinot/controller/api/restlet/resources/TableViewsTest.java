...
public class TableViewsTest extends ControllerTest {
  ...
  public void setupTest()
    ...
    request = new TableConfigJSONBuilder(CommonConstants.Helix.TableType.OFFLINE).setTableName(OFFLINE_ONLY_TABLE)
        .setNumReplicas(2)
        .setBrokerTenant("default")
        .setServerTenant("default")
        .build();
    sendPostRequest(_controllerRequestURLBuilder.forTableCreate(), request.toString());
    addOneSegment(OFFLINE_ONLY_TABLE);

    request = new TableConfigJSONBuilder(CommonConstants.Helix.TableType.OFFLINE).setTableName(TABLE_NAME)
        .setNumReplicas(2)
        .setBrokerTenant("default")
        .setServerTenant("default")
        .build();
    ...
    request = new TableConfigJSONBuilder(CommonConstants.Helix.TableType.REALTIME).setTableName(TABLE_NAME)

...
public class SchemaTest {
  ...
  public void testSerializeDeserialize()
    ...
    // Test the cache of JSON schema
    // When setting new fields, cache should be cleared
    String origJSONSchema = schemaToCompare.getJSONSchema();
    schemaToCompare.setSchemaName("newSchema");
    String newSchemaString = schemaToCompare.getJSONSchema();
    Assert.assertFalse(origJSONSchema.equals(newSchemaString));
  }

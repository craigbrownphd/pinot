...
public class ClusterStarter {
  ...
  private void addTable()
    ...
    String tableConfigJSONString =
        new TableConfigJSONBuilder(CommonConstants.Helix.TableType.OFFLINE).setTableName(_tableName)
            ...
            .build()
            .toString();
    sendPostRequest(ControllerRequestURLBuilder.baseUrl(controllerAddress).forTableCreate(), tableConfigJSONString);
  }
